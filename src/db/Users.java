...
public class Users {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(dbURL,username,password)){
            ...
            //readData(conn);
            //insertData(conn,"kzars","qwerty","Karlis Zars","zars@gmail.com"); //inserts data in data base(workbench)
    ...
    public static void readData (Connection conn) throws SQLException {  //instead of try&catch we use throws SQLException, it is doing the same
        ...
        while(resultSet.next()){
            ...
            String fullName = resultSet.getString("fullname"); //passing needed column name
            String email = resultSet.getString("email");

            String output = "User #%d: %s  -  %s  - %s - %s"; // works as template
            //created method (using String.format) to get info from db
